...
CREATE TABLE tasks (
  ...
  acked_at          TEXT,                      -- принята: прочитана, ясна, вопросов нет
  ...
  t2a_hours         REAL,                      -- до принятия
  t2s_hours         REAL,                      -- Time to start: от принятия до взятия в работу
...
INSERT INTO settings (key, value) VALUES
  ...
  ('column_backlog',    '3b698e71-7a66-4806-a376-92c9890d5d9b'),
  ('column_in_progress','2c8c024a-c0c5-4a6b-b092-7cb284e6427a,c45a6d3a-00e8-4a4b-8408-3fe0f90a5e0b'),
  ('column_review',     '8f532219-77c1-46f1-9700-f00be782255d'),
  ...
  -- «Принята»: прочитана, ясна, вопросов нет
  ('column_acked',      '1a5a5ef8-cae1-47a0-84f3-581bc10a79f3'),
  ...
  ('metric_weights',    'work:50,done:20,t2s:20,quality:10'),
  -- потолок перевыполнения: обгон нормы не должен перекрывать провал
  ('percent_cap',       '120'),
  -- колонки доски «Задачи ассистентов»: задачи с других досок не считаются
  ('board_columns',     '3b698e71-7a66-4806-a376-92c9890d5d9b,1a5a5ef8-cae1-47a0-84f3-581bc10a79f3,2c8c024a-c0c5-4a6b-b092-7cb284e6427a,6402f460-bf23-4ed5-a0d9-ce618332af2e,c5952427-f95b-4b20-87a1-3dbd800f051a,906ca640-b92e-4458-864c-b1e2fc596b4f,8f532219-77c1-46f1-9700-f00be782255d,66b5d0b0-fa13-4026-8c30-0749a01fe3f5,a481b53b-fa5b-4596-b43b-0fd10a04c075,1e0a69b2-b008-419b-89dd-0b0a3ccb6730,c6a58d41-8ef3-4146-bac8-0478c2c6a0ed'),
  ('review_norm_hours', '8'),
...
INSERT INTO sla (metric, level, hours, valid_from, note) VALUES
  ('t2a', 0, 1,  '2026-Q3', 'принять в течение рабочего часа — справочно'),
  ('t2s', 0, 12, '2026-Q3', 'взять в работу в течение 12 рабочих часов от постановки'),
