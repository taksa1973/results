#!/usr/bin/env python3
"""
Добавляет в колоду слова из data/extra_words12.json.
Двенадцатая партия: команда, рыбалка, банк, условные формы.
"""
import json, os

ROOT = os.path.dirname(os.path.abspath(__file__))
D = lambda *p: os.path.join(ROOT, *p)
SRC = "extra_words12.json"
